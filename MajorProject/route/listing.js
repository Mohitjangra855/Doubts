...
Route.post("/", isLoggedIn, validateSchema, wrapAsync(async (req, res, next) => {
...
// update route.....................
Route.put("/:id", isLoggedIn,isOwner, validateSchema, wrapAsync(async (req, res) => {
    let { id } = req.params;
